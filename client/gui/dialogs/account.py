...
class Ui_AccountDialog(object):
    def setupUi(self, AccountDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/src/src/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/src/src/logout.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
